        ...
        PrintWriter out = response.getWriter();
         ServletContext sc=getServletContext();
            ...
            java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/test","root","9211623779");
             ...
             String p=request.getParameter("unn");
...
/*int rfs=st.executeUpdate("delete from tab1 where name='"+p+"'");*/
            ...
            ResultSet rs=st.executeQuery("select* from crimefile where victimname='"+p+"'");
        ...
        try {
            ...
            while(rs.next())
            {
                ...
                out.println("<tr><td>"+rs.getInt(1)+"</td>"+"<td>"+rs.getString(2)+"</td>"+"      "+"<td>"+rs.getString(3)+"</td>"+"	"+"<td>"+rs.getLong(4)+"</td>"+"      "+"<td>"+rs.getString(5)+"</td>"+"  "+"<td>"+rs.getString(6)+"</td>"+"      "+"<td>"+rs.getString(7)+"</td>"+"       "+"<td>"+rs.getString(8)+"</td>"+"      "+"<td>"+rs.getString(9)+"</td>"+"   "+"<td>"+rs.getLong(12)+"</td>"+"     "+"<td>"+rs.getString(19)+"</td>"+"   "+"<td>"+rs.getString(14)+"</td>"+"    "+"<td>"+rs.getLong(18)+"</td>"+"<br>");
